...
def compute_reward(data: DataProto, reward_fn: AbstractRewardManager) -> tuple[torch.Tensor, dict[str, Any]]:
    ...
    try:
        ...
        tool_reward_tensor = reward_result.get("tool_reward_tensor", None)
        tool_step_rewards_tensor = reward_result.get("tool_step_rewards_tensor", None)
    ...
    return reward_tensor, tool_reward_tensor, tool_step_rewards_tensor, reward_extra_infos_dict
